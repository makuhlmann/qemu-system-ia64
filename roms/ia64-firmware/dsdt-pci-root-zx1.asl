        ...
        Device (SBA0)
        {
            ...
            Device (PCI0)
            {
                ...
                Name (_PRT, Package ()
                {
                    ...
                    // Core I/O seats.  The vendor firmware's own SCRAM
                    // records wire device 1 to the rope's first three
                    // interrupts, device 2 to the sixth and device 3 to the
                    // fifth; keep in lockstep with longspeak_pci0_intx in
                    // hw/ia64/longspeak.c.
                    Package () { 0x0001FFFF, 0, 0x00, 16 },
                    Package () { 0x0001FFFF, 1, 0x00, 17 },
                    Package () { 0x0001FFFF, 2, 0x00, 18 },
                    Package () { 0x0001FFFF, 3, 0x00, 19 },
                    Package () { 0x0002FFFF, 0, 0x00, 21 },
                    Package () { 0x0002FFFF, 1, 0x00, 21 },
                    Package () { 0x0002FFFF, 2, 0x00, 21 },
                    Package () { 0x0002FFFF, 3, 0x00, 21 },
                    Package () { 0x0003FFFF, 0, 0x00, 20 },
                    Package () { 0x0003FFFF, 1, 0x00, 20 },
                    Package () { 0x0003FFFF, 2, 0x00, 20 },
                    Package () { 0x0003FFFF, 3, 0x00, 20 },
