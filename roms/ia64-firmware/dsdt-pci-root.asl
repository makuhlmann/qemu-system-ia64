...
DefinitionBlock ("", "DSDT", 2, "QEMU  ", "IA64DSDT", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Device (PCI0)
        {
            ...
            Name (_PRT, Package ()
            {
                Package () { 0x0001FFFF, 0, 0x00, 35 },
                Package () { 0x0001FFFF, 1, 0x00, 34 },
                Package () { 0x0001FFFF, 2, 0x00, 33 },
                Package () { 0x0001FFFF, 3, 0x00, 32 },
                Package () { 0x0002FFFF, 0, 0x00, 39 },
                Package () { 0x0002FFFF, 1, 0x00, 38 },
                Package () { 0x0002FFFF, 2, 0x00, 37 },
                Package () { 0x0002FFFF, 3, 0x00, 36 },
                Package () { 0x0003FFFF, 0, 0x00, 46 },
                Package () { 0x0003FFFF, 1, 0x00, 46 },
                Package () { 0x0003FFFF, 2, 0x00, 47 },
                Package () { 0x0003FFFF, 3, 0x00, 47 },
                Package () { 0x0004FFFF, 0, 0x00, 45 },
                Package () { 0x0004FFFF, 1, 0x00, 45 },
                Package () { 0x0004FFFF, 2, 0x00, 45 },
                Package () { 0x0004FFFF, 3, 0x00, 45 },
                Package () { 0x0005FFFF, 0, 0x00, 44 },
                Package () { 0x0005FFFF, 1, 0x00, 44 },
                Package () { 0x0005FFFF, 2, 0x00, 44 },
                Package () { 0x0005FFFF, 3, 0x00, 44 },
                Package () { 0x0006FFFF, 0, 0x00, 62 },
                Package () { 0x0006FFFF, 1, 0x00, 63 },
                Package () { 0x0006FFFF, 2, 0x00, 60 },
                Package () { 0x0006FFFF, 3, 0x00, 61 },
                Package () { 0x0007FFFF, 0, 0x00, 63 },
                Package () { 0x0007FFFF, 1, 0x00, 60 },
                Package () { 0x0007FFFF, 2, 0x00, 61 },
                Package () { 0x0007FFFF, 3, 0x00, 62 }
            })
        }

        // WXB0 expander root.  It owns exactly bus 1 and its own block of four
        // Programmable Interrupt Device inputs (slot 0 at 19..16, slot 1 at
        // 23..20, slot 2 at 43..40, the hot-plug controller at 56 -- the
        // i2000's wiring, as the vendor DSDT's _PRT gives it), so it shares
        // no interrupt line with the compatibility bus.  Its producer windows are
        ...
        Device (WXB0)
        {
            ...
            Name (_PRT, Package ()
            {
                    Package () { 0x0000FFFF, 0, 0x00, 19 },
                    Package () { 0x0000FFFF, 1, 0x00, 18 },
                    Package () { 0x0000FFFF, 2, 0x00, 17 },
                    Package () { 0x0000FFFF, 3, 0x00, 16 },
                    Package () { 0x0001FFFF, 0, 0x00, 23 },
                    Package () { 0x0001FFFF, 1, 0x00, 22 },
                    Package () { 0x0001FFFF, 2, 0x00, 21 },
                    Package () { 0x0001FFFF, 3, 0x00, 20 },
                    Package () { 0x0002FFFF, 0, 0x00, 43 },
                    Package () { 0x0002FFFF, 1, 0x00, 42 },
                    Package () { 0x0002FFFF, 2, 0x00, 41 },
                    Package () { 0x0002FFFF, 3, 0x00, 40 },
                    Package () { 0x0003FFFF, 0, 0x00, 63 },
                    Package () { 0x0003FFFF, 1, 0x00, 60 },
                    Package () { 0x0003FFFF, 2, 0x00, 61 },
                    Package () { 0x0003FFFF, 3, 0x00, 62 },
                    Package () { 0x0004FFFF, 0, 0x00, 60 },
                    Package () { 0x0004FFFF, 1, 0x00, 61 },
                    Package () { 0x0004FFFF, 2, 0x00, 62 },
                    Package () { 0x0004FFFF, 3, 0x00, 63 },
                    Package () { 0x0005FFFF, 0, 0x00, 61 },
                    Package () { 0x0005FFFF, 1, 0x00, 62 },
                    Package () { 0x0005FFFF, 2, 0x00, 63 },
                    Package () { 0x0005FFFF, 3, 0x00, 60 },
                    Package () { 0x0006FFFF, 0, 0x00, 62 },
                    Package () { 0x0006FFFF, 1, 0x00, 63 },
                    Package () { 0x0006FFFF, 2, 0x00, 60 },
                    Package () { 0x0006FFFF, 3, 0x00, 61 },
                    Package () { 0x000FFFFF, 0, 0x00, 56 },
                    Package () { 0x000FFFFF, 1, 0x00, 56 },
                    Package () { 0x000FFFFF, 2, 0x00, 56 },
                    Package () { 0x000FFFFF, 3, 0x00, 56 }
            })
        }
        ...
        Device (WXB1)
        {
            ...
            Name (_PRT, Package ()
            {
                    Package () { 0x0000FFFF, 0, 0x00, 27 },
                    Package () { 0x0000FFFF, 1, 0x00, 26 },
                    Package () { 0x0000FFFF, 2, 0x00, 25 },
                    Package () { 0x0000FFFF, 3, 0x00, 24 },
                    Package () { 0x0001FFFF, 0, 0x00, 31 },
                    Package () { 0x0001FFFF, 1, 0x00, 30 },
                    Package () { 0x0001FFFF, 2, 0x00, 29 },
                    Package () { 0x0001FFFF, 3, 0x00, 28 },
                    Package () { 0x0002FFFF, 0, 0x00, 62 },
                    Package () { 0x0002FFFF, 1, 0x00, 63 },
                    Package () { 0x0002FFFF, 2, 0x00, 60 },
                    Package () { 0x0002FFFF, 3, 0x00, 61 },
                    Package () { 0x0003FFFF, 0, 0x00, 63 },
                    Package () { 0x0003FFFF, 1, 0x00, 60 },
                    Package () { 0x0003FFFF, 2, 0x00, 61 },
                    Package () { 0x0003FFFF, 3, 0x00, 62 },
                    ...
                    Package () { 0x0006FFFF, 2, 0x00, 60 },
                    Package () { 0x0006FFFF, 3, 0x00, 61 },
                    Package () { 0x000FFFFF, 0, 0x00, 57 },
                    Package () { 0x000FFFFF, 1, 0x00, 57 },
                    Package () { 0x000FFFFF, 2, 0x00, 57 },
                    Package () { 0x000FFFFF, 3, 0x00, 57 }
            })
        }
        ...
        Device (GXB0)
        {
            ...
            Name (_PRT, Package ()
            {
                    Package () { 0x0000FFFF, 0, 0x00, 55 },
                    Package () { 0x0000FFFF, 1, 0x00, 54 },
                    Package () { 0x0000FFFF, 2, 0x00, 55 },
                    Package () { 0x0000FFFF, 3, 0x00, 54 },
                    Package () { 0x0001FFFF, 0, 0x00, 61 },
                    Package () { 0x0001FFFF, 1, 0x00, 62 },
                    Package () { 0x0001FFFF, 2, 0x00, 63 },
                    Package () { 0x0001FFFF, 3, 0x00, 60 },
                    Package () { 0x0002FFFF, 0, 0x00, 62 },
                    Package () { 0x0002FFFF, 1, 0x00, 63 },
                    Package () { 0x0002FFFF, 2, 0x00, 60 },
                    Package () { 0x0002FFFF, 3, 0x00, 61 },
